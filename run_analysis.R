...
data_dir <- "./Dataset"
feature_file <- paste(data_dir, "/UCI HAR Dataset/features.txt", sep = "")
activity_labels_file <- paste(data_dir, "/UCI HAR Dataset/activity_labels.txt", sep = "")
x_train_file <- paste(data_dir, "/UCI HAR Dataset/train/X_train.txt", sep = "")
y_train_file <- paste(data_dir, "/UCI HAR Dataset/train/y_train.txt", sep = "")
subj_train_file <- paste(data_dir, "/UCI HAR Dataset/train/subject_train.txt", sep = "")
x_test_file  <- paste(data_dir, "/UCI HAR Dataset/test/X_test.txt", sep = "")
y_test_file  <- paste(data_dir, "/UCI HAR Dataset/test/y_test.txt", sep = "")
subj_test_file <- paste(data_dir, "/UCI HAR Dataset/test/subject_test.txt", sep = "")
